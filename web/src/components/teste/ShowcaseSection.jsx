...
const ShowcaseSection = () => {
  return (
    <section className="relative overflow-hidden">
      ...
      <HalfCircle className="absolute top-1/4 -left-[190px] opacity-60 dark:opacity-20 -z-10" />
      <HalfCircle className="absolute bottom-1/4 -right-[190px] opacity-60 dark:opacity-20 -z-10" />
      ...
      <div className="max-w-7xl mx-auto py-24 px-6 lg:px-8 grid grid-cols-1 md:grid-cols-2 gap-24 items-center">
        ...
        <div className="relative flex justify-center z-10">
          ...
          <motion.div
            ...
            className="absolute inset-4 sm:inset-6 bg-gradient-to-br from-white/30 to-white/5 dark:from-white/20 dark:to-white/5 backdrop-blur-xl rounded-[4rem] shadow-2xl transform rotate-6"
          />

          <motion.div
            animate={{ rotate: [0, -3, 0] }}
            transition={{ duration: 8, repeat: Infinity, ease: "easeInOut", delay: 1 }}
            className="absolute inset-4 sm:inset-6 bg-gradient-to-br from-white/20 to-white/5 dark:from-white/20 dark:to-white/5 backdrop-blur-md rounded-[4rem] shadow-xl transform -rotate-3" // MODIFICADO
          />
