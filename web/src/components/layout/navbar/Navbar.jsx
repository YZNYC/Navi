...
export default function Navbar({ onToggleSidebar }) {
    ...
    // CORREÇÃO: Pega o estado 'isLoading' do novo AuthContext
    ...
    // Funções para garantir que apenas um dropdown esteja aberto por vez
    ...
    // CORREÇÃO: Enquanto o AuthContext estiver verificando os dados, mostramos um placeholder.
    if (isLoading) {
...
// Estes são os seus componentes originais, sem alterações.
...
const ProfileButton = ({ user, logout, isOpen, setIsOpen, isMobile = false }) => {
    // A guarda secundária permanece por segurança, mas 'isLoading' é a principal defesa.
