...
const ConfirmationModal = ({ message, onClose }) => {
    ...
    // O modal de sucesso usa tons de âmbar para combinar com o tema
    return (
...
const PricingCard = ({ plan, onActivate, placa }) => {
    ...
    return (
        <div className={`
            ...
            ${isFeatured
                ? 'border-amber-500 ring-4 ring-amber-100 lg:transform lg:scale-115' // CORRIGIDO: Aplica transform scale APENAS em telas grandes (lg:) para garantir a responsividade
...
export default function AtivarPlanos() {
    ...
    return (
        <div className="pt-0 pb-8 lg:pb-12 mx-auto min-h-screen bg-gray-50">
